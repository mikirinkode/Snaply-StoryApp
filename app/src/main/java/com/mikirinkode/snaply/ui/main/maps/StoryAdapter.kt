...
class StoryAdapter(private val activity: Activity) : RecyclerView.Adapter<StoryAdapter.StoryViewHolder>() {
    ...
    inner class StoryViewHolder(private val binding: ItemStoryMapsBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): StoryViewHolder {
        val binding = ItemStoryMapsBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    fun getStoryByPosition(position: Int): StoryEntity {
